...
INSERT INTO places (
  ...
  ARRAY[]::text[],
  ARRAY[]::text[],
  '{"entries": [{"day": "Tous les jours", "hours": "09:30–19:00"}], "note": "Ouvert tous les jours 09:30–19:00 (site officiel). Adulte : 80 MAD ; résidents marocains : 50 MAD ; moins de 15 ans : gratuit. Billet aussi valable au Musée de la Musique de Marrakech."}'::jsonb
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO places (
  slug, name, city_name, category, category_label, neighborhood, price_level,
  is_editors_pick, image_color, summary, practical_tips, best_time_to_visit, maps_url,
  ...
  ARRAY[]::text[],
  ARRAY[]::text[],
  '{"entries": [{"day": "Lundi", "hours": "Fermé"}, {"day": "Mardi", "hours": "Fermé"}, {"day": "Mercredi", "hours": "10:00–18:00"}, {"day": "Jeudi", "hours": "10:00–18:00"}, {"day": "Vendredi", "hours": "10:00–18:00"}, {"day": "Samedi", "hours": "10:00–18:00"}, {"day": "Dimanche", "hours": "10:00–18:00"}], "note": "Adulte : 120 MAD ; résidents / nationaux africains : 60 MAD ; étudiants et moins de 12 ans : gratuit avec pièce d''identité (macaal.org). Ramadan : 10:00–15:30."}'::jsonb
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO places (
  slug, name, city_name, category, category_label, neighborhood, price_level,
  is_editors_pick, image_color, summary, practical_tips, best_time_to_visit, maps_url,
