...
abstract final class AtlasTypography {
  static TextTheme textTheme({Color? color}) {
    ...
    return TextTheme(
      ...
      headlineLarge: style(size: 24, height: 30, weight: FontWeight.w600, letterSpacing: -0.3),
      headlineMedium: style(size: 20, height: 26, weight: FontWeight.w600, letterSpacing: -0.2),
      headlineSmall: style(size: 20, height: 26, weight: FontWeight.w600, letterSpacing: -0.2),
      titleLarge: style(size: 18, height: 24, weight: FontWeight.w600),
      titleMedium: style(size: 16, height: 22, weight: FontWeight.w500),
      titleSmall: style(size: 14, height: 20, weight: FontWeight.w500, letterSpacing: 0.1),
      ...
      labelLarge: style(size: 14, height: 20, weight: FontWeight.w600, letterSpacing: 0.1),
