...
/// Indicateur discret de l'état du catalogue distant.
///
/// Visible uniquement en [EditorialCatalogLoadState.stale] ou
/// [EditorialCatalogLoadState.error] — pas de bandeau pour idle/loading/success.
class PlaceCatalogStatusIndicator extends StatelessWidget {
  const PlaceCatalogStatusIndicator({
    super.key,
