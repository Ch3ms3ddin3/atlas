...
void main() {
  testWidgets(
    'AtlasOfflineNotice under SafeArea starts below the top inset',
    (tester) async {
      const topInset = 59.0;
      ...
      expect(
        tester.getTopLeft(find.byType(AtlasOfflineNotice)).dy,
        topInset,
      );
      expect(
        find.textContaining('Hors ligne — Atlas continue'),
        findsOneWidget,
      );
    },
  );
